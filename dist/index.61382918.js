...
})({"cZ3CG":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "efb3fe3c61382918";
...
function getDayofWeek(num) {
    ...
    let totalNum;
    if (num > 0) totalNum = dayNum + num;
    else totalNum = dayNum;
    if (totalNum > 7) totalNum = totalNum - 7;
    if (totalNum === 1) {
        dayName = "Monday";
        return {
            dayName
